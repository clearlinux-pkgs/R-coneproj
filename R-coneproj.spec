...
Version  : 1.17
Release  : 11
URL      : https://cran.r-project.org/src/contrib/coneproj_1.17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/coneproj_1.17.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697474210
