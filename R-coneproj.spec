...
Version  : 1.15
Release  : 1
URL      : https://cran.r-project.org/src/contrib/coneproj_1.15.tar.gz
Source0  : https://cran.r-project.org/src/contrib/coneproj_1.15.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1633386360
